...
const versions: Version[] = [
    {
        version: '2.5.6',
        name: 'Data Visibility & Persistence Repair',
        keywords: ['RLS-Fix', 'Product-List-Restore', 'Upsert-Null-Safe'],
        type: 'correcao',
        status: 'concluido',
    },
    {
    ...
    {
        version: '2.5.2',
        name: 'BuyPix Production Ready: Sincronização & Estabilidade',
        keywords: ['Database-Sync', 'Resilience-API', 'Final-Deploy', 'BuyPix-Full'],
        type: 'lancamento',
        status: 'concluido',
    },
    {
        version: '2.5.1',
        name: 'Sidebar Sync: Contagem de Gateways Corrigida',
        keywords: ['UI-Sync', 'Sidebar-Counter', 'BuyPix-Active'],
        type: 'correcao',
        status: 'concluido',
    },
    {
        version: '2.5.0',
        name: 'BuyPix Integration: Gateway de Pagamento Instantâneo',
        keywords: ['BuyPix', 'Checkout-Sync', 'Webhook-Secure', 'Product-Gateways', 'Mobile-Icons'],
        type: 'funcionalidade',
        status: 'concluido',
    },
    {
        version: '2.4.1',
        name: 'Rastreamento Universal & Recuperação de Vendas',
        keywords: ['UTMify-Sync', 'Purchase-Fix', 'Algoritmo-Correspondência', 'MundPay-Rescue'],
        type: 'funcionalidade',
        status: 'concluido',
    },
    {
        version: '2.4.0',
        name: 'Sincronização de Ambiente & Auto-Configurações',
        keywords: ['ENV-Detection', 'Auto-fill', 'Sidebar-Indicators', 'Realtime-Logs'],
        type: 'funcionalidade',
        status: 'concluido',
    },
    {
        version: '2.2.0',
        name: 'Dashboard: Auditoria de Logs & Webhooks em Tempo Real',
        keywords: ['System-Logs', 'Realtime-Auditing', 'Webhook-Tracker', 'MundPay-Pix-Fix'],
        type: 'funcionalidade',
        status: 'concluido',
    },
    {
        version: '2.1.0',
        name: 'Trinity v4: Ultra-Tracking UTMify Robustness',
        keywords: ['InitiateCheckout', 'Purchase', 'Redundancy', 'FocusTrigger'],
        type: 'funcionalidade',
        status: 'concluido',
    },
    {
        version: '2.0.0',
        name: 'PRIMEIRO LANÇAMENTO real funcional',
        keywords: ['Supabase-Fixed', 'UTMify-Ready', 'Real-Sales-Data', 'Trinity-UI', 'Full-Fixed'],
        type: 'lancamento',
        status: 'concluido',
    },
    {
        version: '1.9.0',
        name: 'Trinity AI v4.0.0: Modernização Grok & Vision Support',
        keywords: ['Trinity-v4', 'Grok-Style', 'Vision-API', 'Ultra-Dark-UI', 'Mobile-Vision'],
        type: 'funcionalidade',
        status: 'concluido',
    },
    {
